var express = require('express'), connect = require('connect'), util = require('util');

var app = express.createServer(connect.logger(), connect.static(__dirname), connect.static('..'));
